/*
 * cardtest1.c
 * Call Adventurer card and check for bugs
...
int main() {
	...
	// Updated call to adventurer with reorganized arguments
	adventurerCard(drawntreasure, &G, currentPlayer, cutpurse, temphand);
