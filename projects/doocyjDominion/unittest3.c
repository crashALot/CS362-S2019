/*
 * unittest3.c
 * Call Baron card and check for bugs
...
int main() {
	...
	while (G.supplyCount[estate]>0)
	{
		...
		// Baron is called through cardEffect function as team mate did not refactor Baron function
		cardEffect(baron, 0, 0, 0, &G, handPos, 0);
		// Old code
